 ...
 *                   Gareth Davis;
 *
 * $Id: SortButtonRenderer.java,v 1.7 2004/05/25 09:13:16 mungady Exp $
 *
...
public class SortButtonRenderer implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table,
        ...
        SortableTableHeader header = (SortableTableHeader) table.getTableHeader();
        ...
        if (table != null) {
          TableModelListener tml = new TableModelListener()
          {
           ...
           if (header.getSortingColumn() == cc) {
              if (header.getAscending()) {
