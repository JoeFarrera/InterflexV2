...
public class FormTestReservarEntrada extends JFrame 
{
  // form layout
...
// The status bar
  ...
  private MDPanelSgaventradaspendienteView1SgavdisponibleentradaView2 dataPanel = new MDPanelSgaventradaspendienteView1SgavdisponibleentradaView2();
...
// menu definitions
  ...
  public void jbInit() throws Exception
  {
    ...
    this.setTitle("Reservar Entrada Tester");
    ...
    this.setSize(new Dimension(771, 553));
  ...
  public static void main(String [] args)
  {
    ...
    try
    {
      ...
      app.getApplicationModule().fetchAttributeProperties(new String[] {"SgaventradaspendienteView1", "SgavdisponibleentradaView2"}, new String[][] {{"Iddoc", "Prioridad", "Estadocab", "Idlin", "Idbulto", "Cantot", "Canpen", "Canres", "Estadolinea", "Idpuesto", "Idart", "Idartif", "Idtipmac", "Relleno", "Tolfifo", "Controlpes", "Pesunit", "Unimac", "Rotacion"}, {"Iddoc", "Idlin", "Idbulto", "Idmac", "Idart", "Cantot", "Canres", "Unimac", "Ubipos", "Posubipos", "Idtipmac"}}, null);
      FormTestReservarEntrada frame = new FormTestReservarEntrada();
  ...
  private int _popupTransactionDialog()
  {
    ...
    if (panelBinding.isTransactionDirty())
    {
      ...
      int action = JOptionPane.showOptionDialog(es.sysmap.interflex.controltest.FormTestReservarEntrada.this, "How do you want to close the transaction?", "Transaction open", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[(0)]);
   ...
   */
  public FormTestReservarEntrada()
  {
