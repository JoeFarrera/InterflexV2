...
public class FormSgacdocTL1SgavresmattlView1 extends JFrame 
{
  // form layout
  ...
  private JUPanelBinding panelBinding = new JUPanelBinding("MDPanelSgacdocTL1SgavresmattlView1UIModel");
...
// The status bar
  ...
  private MDPanelSgacdocTL1SgavresmattlView1 dataPanel = new MDPanelSgacdocTL1SgavresmattlView1();
...
// menu definitions
  ...
  public static void main(String [] args)
  {
    ...
    try
    {
      ...
      app.getApplicationModule().fetchAttributeProperties(new String[] {"SgacdocTL1", "SgavresmattlView1"}, new String[][] {{"Iddoc", "Estado"}, {"Idmac", "Idartif", "Descarticulo", "Cantot", "Canres", "Descestexist", "Descvisualpos", "Descvisualdes", "Createdon", "Modifiedon"}}, null);
      FormSgacdocTL1SgavresmattlView1 frame = new FormSgacdocTL1SgavresmattlView1();
  ...
  private int _popupTransactionDialog()
  {
    ...
    if (panelBinding.isTransactionDirty())
    {
      ...
      int action = JOptionPane.showOptionDialog(FormSgacdocTL1SgavresmattlView1.this, "How do you want to close the transaction?", "Transaction open", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[(0)]);
   ...
   */
  public FormSgacdocTL1SgavresmattlView1()
  {
