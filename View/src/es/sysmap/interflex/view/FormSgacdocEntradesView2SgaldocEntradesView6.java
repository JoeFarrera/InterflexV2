...
public class FormSgacdocEntradesView2SgaldocEntradesView6 extends JFrame 
{
  // form layout
...
// The status bar
  ...
  private MDPanelSgacdocEntradesView2SgaldocEntradesView6 dataPanel = new MDPanelSgacdocEntradesView2SgaldocEntradesView6();
...
// menu definitions
  ...
  public static void main(String [] args)
  {
    ...
    try
    {
      ...
      DCDataControl app = (DCDataControl)ctx.get("AppModuleDataControl");
      app.setClientApp(DCDataControl.JCLIENT);
      app.getApplicationModule().fetchAttributeProperties(new String[] {"SgacdocEntradesView1", "SgaldocEntradesView2"}, new String[][] {{"Iddoc", "Idcabstr", "Idcabnum", "Numlineas", "Numbultos", "Estado", "Operario", "Pestotal", "Motivo", "Nombre", "Direccion", "Codpostal", "Poblacion", "Provincia", "Telefono", "Portes", "Falbaran", "Spedido", "Pais", "Transporte", "Reembolso", "Talbaran", "Nalbaran", "Codempresa", "Transp", "Tportes", "Ccliente", "Idultbulto", "Idtipdoc", "Prioridad", "Estadolineas", "Descestado", "Descestadolineas", "Imprimir", "Estcom", "Idpuestofin", "Fpedido", "Tipdocsga", "TipoEnvio"}, {"Idbulto", "Iddoc", "Idlin", "Cantotbulto", "Canresbulto", "Canpenbulto", "Estadobulto", "Idtipmac", "Unimac", "Relleno", "Cantot", "Canres", "Canpen", "Idlin1", "Iddoc1", "Idartif", "Descrip", "Cancon", "Idmac", "Idart", "Idcabnum", "Idcabstr", "Observ", "Descestado", "Descestadobulto", "Desctipmac", "Pesini", "Pesfin", "Difpes", "Canentbulto", "Peso", "Estado", "Integra", "Modifiedby", "Idubi", "Descubi"}}, null);
      FormSgacdocEntradesView2SgaldocEntradesView6 frame = new FormSgacdocEntradesView2SgaldocEntradesView6();
  ...
  private int _popupTransactionDialog()
  {
    ...
    if (panelBinding.isTransactionDirty())
    {
      ...
      int action = JOptionPane.showOptionDialog(FormSgacdocEntradesView2SgaldocEntradesView6.this, "How do you want to close the transaction?", "Transaction open", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[(0)]);
   ...
   */
  public FormSgacdocEntradesView2SgaldocEntradesView6()
  {
