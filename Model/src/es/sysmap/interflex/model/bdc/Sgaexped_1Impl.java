...
public class Sgaexped_1Impl extends EntityImpl 
{
  public static final int IDEXPED = 0;
  public static final int CREATEDBY = 1;
  public static final int MODIFIEDBY = 2;
  public static final int CREATEDON = 3;
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("es.sysmap.interflex.model.bdc.Sgaexped_1");
    }
  ...
  protected void create(AttributeList attributeList)
  {
    ...
    // SequenceImpl idExpedSeq = new SequenceImpl("SEQ_IDEXPED", getDBTransaction());
