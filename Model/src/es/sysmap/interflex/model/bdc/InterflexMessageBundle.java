...
public class InterflexMessageBundle extends ListResourceBundle 
{
  ...
  private static final Object[][] sMessageStrings = new String[][] 
  {
    ...
    { ETIQUETA_CANTNOLEGIBLE, "No s'ha pogut llegir la cantitat de la etiqueta. Format etiqueta: Article (fins 10) + quantitat (5)" },
    { ARTICLE_INEXISTENT_RF, "No existeix cap article amb la referència {0}. Format etiqueta: Article (fins 10) + quantitat (5)" },
    { UBICACION_INEXISTENT, "No existeix cap ubicació amb aquestes coordenades {0}." },
    { DOCUMENTO_NO_ENCONTRADO, "No existe documento de entrada para la etiqueta {0}." },
