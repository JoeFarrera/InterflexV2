...
public class FormSgacdocTL1SgaresmattlView1 extends JFrame 
{
  // form layout
  ...
  private JUPanelBinding panelBinding = new JUPanelBinding("MDPanelSgacdocTL1SgaresmattlView1UIModel");
...
// The status bar
  ...
  private MDPanelSgacdocTL1SgaresmattlView1 dataPanel = new MDPanelSgacdocTL1SgaresmattlView1();
...
// menu definitions
  ...
  public static void main(String [] args)
  {
    ...
    try
    {
      ...
      app.getApplicationModule().fetchAttributeProperties(new String[] {"SgacdocTL1", "SgaresmttlView1"}, new String[][] {{"Iddoc", "Estado"}, {"Idmac", "Createdby", "Modifiedby", "Createdon", "Modifiedon"}}, null);
      FormSgacdocTL1SgaresmattlView1 frame = new FormSgacdocTL1SgaresmattlView1();
  ...
  private int _popupTransactionDialog()
  {
    ...
    if (panelBinding.isTransactionDirty())
    {
      ...
      int action = JOptionPane.showOptionDialog(FormSgacdocTL1SgaresmattlView1.this, "How do you want to close the transaction?", "Transaction open", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[(0)]);
   ...
   */
  public FormSgacdocTL1SgaresmattlView1()
  {
