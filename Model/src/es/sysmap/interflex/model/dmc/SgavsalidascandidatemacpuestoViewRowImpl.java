...
public class SgavsalidascandidatemacpuestoViewRowImpl extends ViewRowImpl implements es.sysmap.interflex.model.dmc.common.SgavsalidascandidatemacpuestoViewRow 
{
  ...
  public static final int CANTOT = 9;
  public static final int CANPEN = 10;
  public static final int CANRES = 11;
  public static final int CANDIS = 12;
  ...
  public static final int FECENT = 17;
  public static final int CANRESEXISTENCIA = 18;
  public static final int SGAMACVIEW = 19;
  public static final int SGALDOCVIEW = 20;
  /**
   * 
   *  This is the default constructor (do not remove)
   */
  public SgavsalidascandidatemacpuestoViewRowImpl()
  {
  }
  
  public String toString()
  {
    return "Doc: " + getIddoc() + " Idlin: " + getIdlin() + " Puesto: " + getIdpuesto() + " Con: " + getIdmac() + " Art: " + getIdartif() + " Candis: " + getCandis();
  }
   ...
   * NOTA: Mismo código en SgavsalidascandidateView
   */
  public boolean reservarSalida()
  {
    ...
    if (macRow.reservarSalidaMaterial(getUbides(), getIdart(), canAReservar, 0))
    {
