...
public class FormSgacdocTLView1SgavexistenciaTLView1 extends JFrame 
{
  // form layout
...
// The status bar
  ...
  private MDPanelSgacdocTLView1SgavexistenciaTLView1 dataPanel = new MDPanelSgacdocTLView1SgavexistenciaTLView1();
...
// menu definitions
  ...
  public static void main(String [] args)
  {
    ...
    try
    {
      ...
      app.getApplicationModule().fetchAttributeProperties(new String[] {"SgacdocTLView1", "SgavexistenciaTLView1"}, new String[][] {{"Iddoc", "Idcabstr", "Idcabnum", "Numlineas", "Numbultos", "Estado", "Nombre", "Descestadolineas", "Tipdocsga", "Idtipdoc", "Descestado"}, {"Iddoc", "Idartif", "Descarticulo", "Cantot", "Canres", "Modifiedon", "Descestexist", "Idmac", "Desctipmac", "Multiref", "Descvisualpos", "Descvisualdes", "Idtipmac", "Estado", "Createdon"}}, null);
      FormSgacdocTLView1SgavexistenciaTLView1 frame = new FormSgacdocTLView1SgavexistenciaTLView1();
  ...
  private int _popupTransactionDialog()
  {
    ...
    if (panelBinding.isTransactionDirty())
    {
      ...
      int action = JOptionPane.showOptionDialog(FormSgacdocTLView1SgavexistenciaTLView1.this, "How do you want to close the transaction?", "Transaction open", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[(0)]);
   ...
   */
  public FormSgacdocTLView1SgavexistenciaTLView1()
  {
